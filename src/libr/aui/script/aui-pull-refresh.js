...
/*(function(window) {
	...
	auiPullToRefresh.prototype = {
        ...
        _init : function(callback) {
			var direction='afterbegin';
			var self = this;
			//self.params.direction=='up'&&(direction='beforeEnd')
			var loadingHtml = '<div class="aui-refresh-load"><div class="aui-refresh-pull-arrow"></div></div>';
			self.params.container.insertAdjacentHTML(direction, loadingHtml);
...
module.exports=auiPullToRefresh;
