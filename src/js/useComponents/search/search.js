 ...
 avalon.component('ms-search', {
     template: tpl,
     defaults: {
         labelStatus:false,//是否显示标签搜索默认显示
         ...
         searchValue: '',
         seltID: 'a',//用示控制下拉显示
         shopId:avalon.store.get('shopId'),
         hostshop:'',//标签
         hostBrand:'', //品牌host
         ssoService:'',//店铺HOST
         Submit: avalon.noop,
         ...
         onInit: function () {
             ...
             if(this.hostshop!=''&&this.role==1){
                 //获取标签
                 this.labelStatus=true;
                 avalon.ajax({
                     url: this.hostshop+'/goodsLabel/'+avalon.store.get('shopId'),//
                     type: 'get',
                     cache: true,
                     contentType:'application/json;charset=utf-8',
                 }).done(function (ret) {
             ...
             if(this.hostBrand!='') {
                 ...
                 if(this.role==1){
                     var aUrl=this.ssoService+'/manage/shopInfo/shop/' + avalon.store.get('shopId');
         ...
         , onselectClass: function (e, el,i) {
             ...
             switch (i){
                 ...
                 case 1:
                     ...
                     this.data[2]='商品品目';
                     this.selectData['goodssubclassifyname']='';
                     this.data[5]='商品款式';
                     this.selectData['goodsstylename']='';
                     this.data2.arr=[];this.data3.arr=[];this.data4.arr=[];this.data5.arr=[];
                     if(el.children.length>0){
                         this.data2['arr']=el.children.$model;
                         avalon.each(this['data2']['arr'],function(i,els){
                             me.data2.conArr.push(els.clazzname)
                         });
                     }else if(el.stylelist.length>0){
                         this.data5.arr=el.stylelist.$model;
                         me.data5.conArr=[];
                 ...
                 case 2:
                     ...
                     this.data[i] = el.clazzname;
                     this.data[3]='二级品目';
                     this.selectData['goodsthreeclassifyname']='';
                     this.data[5]='商品款式';
                     this.selectData['goodsstylename']='';
                     this.data3.arr=[];this.data4.arr=[];this.data5.arr=[];
                     if(el.children.length>0){
                         this['data3']['arr']=el.children.$model;
                 ...
                 case 3:
                     ...
                     this.data[i] = el.clazzname;
                     this.data[4]='三级品目';
                     this.selectData['goodsfourclassifyname']='';
                     this.data[5]='商品款式';
                     this.selectData['goodsstylename']='';
                     this.data4.arr=[];this.data5.arr=[];
                     if(el.children.length>0){
                         this['data4']['arr']=el.children.$model;
                         this.data4.conArr=[];
                 ...
                 case 4://最后一级品类
                     ...
                     if(el.stylelist.length>0){
                         this['data5']['arr']=el.children.$model;
                         this.data5.conArr=[];
                         avalon.each(this['data5']['arr'],function(i,els){
                             me.data5.conArr.push(els.gd_styleName)
                         });
